...
export const Onboarding: FC = () => {
  ...
  return (
    <div class="flex flex-col items-center">
      {getStarted ? <OnboardingForms /> : null}
      <img
        src="/logo192.png"
        alt="AgroInvest Logo"
        class="w-100 mb-4 rounded-full shadow"
      />
        ...
        <div class="mb-6">
          ...
          <div class="text-neutral-600">
            ...
            <div class="w-full flex justify-center">
              <Link
                href={routes.policy.redirectUri}
                class="text-lg text-secondary-700 underline text-center font-black"
              >
                Privacy and Policy
              </Link>
            </div>
      ...
      <div className="fixed bottom-20 right-10 left-10 flex justify-center">
        <Button className="w-fit" onClick={() => setGetStarted(true)}>
          Get Started
        </Button>
      </div>
    </div>
